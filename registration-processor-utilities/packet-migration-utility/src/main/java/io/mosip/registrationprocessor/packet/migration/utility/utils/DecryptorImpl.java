...
import io.mosip.registrationprocessor.packet.migration.utility.dto.CryptomanagerRequestDto;
import io.mosip.registrationprocessor.packet.migration.utility.dto.CryptomanagerResponseDto;
import io.mosip.registrationprocessor.packet.migration.utility.exception.PacketDecryptionFailureExceptionConstant;
...
public class DecryptorImpl {
	...
	public InputStream decrypt(InputStream encryptedPacket, String registrationId)
		...
		try {
		    ...
		    String apiHostIpPort = env.getProperty("DMZCRYPTOMANAGERDECRYPT");
			UriComponentsBuilder builder = null;
			if (apiHostIpPort != null)
				builder = UriComponentsBuilder.fromUriString(apiHostIpPort);
			response = (CryptomanagerResponseDto)restClient.postApi(builder.toUriString(), null, request, CryptomanagerResponseDto.class, false);

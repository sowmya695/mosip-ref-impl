package io.mosip.registrationprocessor.packet.migration.utility.builder;
...
import io.mosip.registrationprocessor.packet.migration.utility.dto.AuditRequestDto;
import io.mosip.registrationprocessor.packet.migration.utility.dto.AuditResponseDto;
...
public class AuditLogRequestBuilder {
	...
	@Autowired
	private RestApiClient registrationProcessorRestService;

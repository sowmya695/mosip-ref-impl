...
import io.mosip.registrationprocessor.packet.migration.utility.constant.CryptomanagerConstant;
...
public class CryptomanagerRequestDto {
	...
	@NotBlank(message = io.mosip.registrationprocessor.packet.migration.utility.constant.CryptomanagerConstant.INVALID_REQUEST)
